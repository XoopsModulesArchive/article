 ...
 * Article management
 *
 * Import data from wfsection 2.07
...
$sql =	
			...
			" 	FROM ".$GLOBALS['xoopsDB']->prefix("wfs_category").
			"		ORDER BY id ASC"
			;
...
$sql =	
			...
			" 	FROM ".$GLOBALS['xoopsDB']->prefix("wfs_article").
...
$sql =	
			...
			" 	FROM ".$GLOBALS['xoopsDB']->prefix("wfs_votedata").
