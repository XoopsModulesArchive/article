...
define("_MA_SEARCH_GROUP_DESC", "Rank/Level will be ignored if group is specified");
define("_MA_SEARCH_LEVEL", "Level");
define("_MA_SEARCH_LEVEL_ACTIVE", "Active");
define("_MA_SEARCH_LEVEL_INACTIVE", "Inactive");
define("_MA_SEARCH_LEVEL_DISABLED", "Disabled");
